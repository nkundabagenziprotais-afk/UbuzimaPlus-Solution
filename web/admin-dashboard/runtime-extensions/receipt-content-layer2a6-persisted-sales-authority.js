(() => {
  ...
  const VERSION = "2026.08.receipt-content-layer2a5-r3-identity";
  ...
  function legacyCustomerName(invoice) {
    return first(
  ...
  function legacyCustomerTin(invoice) {
    return first(
  ...
  /*
   * AQUILA_RECEIPT_PERSISTED_SALES_AUTHORITY_V1
   *
   * Receipt and Sales Register consume the same
   * persisted invoice.sales_register data.
   */

  function persistedSalesAuthorityText(
    value,
  ) {
    return String(
      value
...
>
  ...
  >
    ...
    ${
      insuranceName(invoice)
        ? `
    <div class="receipt-pair">
      <span>Insurance Name</span>
      <strong data-insurance-name>
        ${escapeHtml(
          insuranceName(invoice),
        )}
      </strong>
