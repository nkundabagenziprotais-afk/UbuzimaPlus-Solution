(() => {
  ...
  const VERSION =
    "2026.08.sales-recording-integrity-v3.7-r3-deterministic-receipt-identity";

  if (
    window
      .__UBUZIMA_SALES_RECORDING_INTEGRITY_V3_7_R3__
  ) {
    return;
  }
  ...
  const CACHE_PREFIX =
    "ubuzima.sales.integrity.v3.7.r3.authoritative";
...
`;
  ...
  console.info(
    "[Ubuzima+] V3.7-R3 deterministic sales + persisted receipt identity loaded.",
    VERSION,
  );
})();
