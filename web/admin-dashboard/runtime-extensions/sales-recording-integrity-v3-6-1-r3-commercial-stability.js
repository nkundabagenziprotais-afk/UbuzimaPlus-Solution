(() => {
  ...
  const VERSION =
    "2026.08.sales-recording-integrity-v3.6.1-r3-commercial-stability";

  if (
    window
      .__UBUZIMA_SALES_RECORDING_INTEGRITY_V3_6_1_R3__
  ) {
    return;
  }
  ...
  const CACHE_PREFIX =
    "ubuzima.sales.integrity.v3.6.1.r3";
  ...
  function enrichInsuranceCheckout(
    info,
    input,
    init,
  ) {
    ...
    try {
      ...
      state.insurancePayloadEnrichments =
        Number(
          state.insurancePayloadEnrichments
          || 0,
        )
...
`;
  ...
  console.info(
    "[Ubuzima+] Sales Integrity V3.6.1-R3 commercial stability loaded.",
    VERSION,
  );
})();
