...
function ubuzimaIconFor(label: string): string {
  ...
  if (/\b(pos|counter|cashier|checkout|till)\b/.test(value)) return "/admin/dock-icons/pos.svg";
  if (/\b(product master|medicine|drug|catalog)\b/.test(value)) return "/admin/dock-icons/product-master.svg";
  if (/\b(inventory|product inventory|available stock)\b/.test(value)) return "/admin/dock-icons/inventory.svg";
  if (/\b(general stock|warehouse|store stock)\b/.test(value)) return "/admin/dock-icons/general-stock.svg";
  ...
  if (/\b(insurance|claim|policy)\b/.test(value)) return "/admin/dock-icons/insurance.svg";
  if (/\b(report|analytics|statistics)\b/.test(value)) return "/admin/dock-icons/reports.svg";
  if (/\b(admin|security|permission|role|access)\b/.test(value)) return "/admin/dock-icons/admin.svg";
  if (/\b(setting|configuration)\b/.test(value)) return "/admin/dock-icons/settings.svg";
  if (/\b(user|staff|pharmacist|patient)\b/.test(value)) return "/admin/dock-icons/users.svg";
