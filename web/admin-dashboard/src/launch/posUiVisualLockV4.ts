...
function iconFor(label: string): string {
  ...
  if (value.includes("pos")) return "./dock-icons/pos.svg";
  if (value.includes("inventory")) return "./dock-icons/inventory.svg";
  if (value.includes("report")) return "./dock-icons/reports.svg";
