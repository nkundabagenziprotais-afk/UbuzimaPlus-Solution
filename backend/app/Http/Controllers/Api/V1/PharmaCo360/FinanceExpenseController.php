...
class FinanceExpenseController extends Controller
{
        ...
        return response()->json([
            ...
            'expenses' =>
                $query
                    ->limit($limit)
                    /*
                 * AQUILA_FINANCE_EXPENSE_REGISTER_NEWEST_FIRST_R24
                 *
                 * Expense Register default:
                 * newest business expense date first.
                 *
                 * Same-date tie breaker:
                 * newest created record first.
                 */
                ->reorder()
                ->orderByDesc(
                    'business_date'
    ...
    public function referenceData(
        ...
        /*
         * AQUILA_FINANCE_EXPENSE_PAYEE_ADMIN_USERS_R24
         *
         * Read-only minimal projection from Admin -> Users authority.
         *
         * Current tenant only.
         ...
         * - email
         *
         * No role-management permission bypass.
         */
        $payeeUsers =
