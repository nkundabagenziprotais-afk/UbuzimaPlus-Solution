...
class RoleGovernanceApiTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_security_audit_timeline_is_tenant_isolated(): void
    {
        $this->seed();
        ...
        $response = $this
            ...
            ->withToken($token)
            ->getJson(
                '/api/v1/access-check/security/audit-timeline?limit=100'
            )
            ->assertOk()
            ->assertJsonPath(
                'tenant.slug',
